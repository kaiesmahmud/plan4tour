export  const hotels = [
    {
        ...
        facilities : [
            ...
            },
            {
                name: "Lobby",
                icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...$$props}>
                    <path fill="currentColor" d="M18.444 18H5.556a3.57 3.57 0 0 1-.806-.092V19a.75.75 0 0 1-1.5 0v-1.849A3.548 3.548 0 0 1 2 14.444V12a2 2 0 1 1 4 0v1.2a.8.8 0 0 0 .8.8h10.4a.8.8 0 0 0 .8-.8V12a2 2 0 1 1 4 0v2.444a3.548 3.548 0 0 1-1.25 2.707V19a.75.75 0 0 1-1.5 0v-1.092a3.57 3.57 0 0 1-.806.092" />
                    <path fill="currentColor" d="M4.007 9c.008-.328.027-.566.07-.78A4 4 0 0 1 7.22 5.077C7.606 5 8.07 5 9 5h6c.93 0 1.394 0 1.78.077a4 4 0 0 1 3.143 3.143c.043.214.062.452.07.78H20v1a2 2 0 0 0-2 2v1.2a.8.8 0 0 1-.8.8H6.8a.8.8 0 0 1-.8-.8V12a2 2 0 0 0-2-2V9z" opacity="0.5" />
                </svg>`,
            },
            {
                name: "24 Hour Security",
                icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48" {...$$props}>
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m24 24l5.303-5.303A7.5 7.5 0 1 0 31.5 24" />
            ...
            },
            {
                name: "Wifi",
                icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...$$props}>
                    <path fill="currentColor" d="m6.35 15.35l-1.023-1.035q1.334-1.345 3.056-2.06q1.722-.717 3.615-.717q1.894 0 3.618.723q1.724.722 3.057 2.066L17.65 15.35q-1.125-1.125-2.587-1.737T12 13q-1.6 0-3.062.613T6.35 15.35M2.1 11.1l-1.023-1.023Q3.26 7.883 6.087 6.71q2.828-1.173 5.917-1.173q3.088 0 5.912 1.173q2.824 1.172 5.007 3.366L21.9 11.1q-1.975-1.975-4.537-3.037T12 7Q9.2 7 6.637 8.063T2.1 11.1M12 21l-2.448-2.454q.486-.486 1.119-.747q.633-.26 1.327-.26t1.329.26q.634.26 1.121.747z" />
                </svg>`,
            }, 
        ],
        multipleImgs:[
            {
                src: 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGhvdGVsfGVufDB8fDB8fHww',
                alt: "some dummy data"
            },
            {
                src: 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGhvdGVsfGVufDB8fDB8fHww',
